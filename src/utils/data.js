...
export const projectsData = [
  {
    ...
    highlights: [
      ...
      "Architected a server-side API proxy with strict input allowlisting, AbortController timeouts, and a sliding-window rate limiter, then documented its serverless multi-instance weakness and why the real protection is a Google Cloud hard billing cap, not the limiter itself.",
