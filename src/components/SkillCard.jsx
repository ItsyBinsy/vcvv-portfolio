  ...
  return (
    <>
      <div
        ...
        className="group relative flex-shrink-0 w-full aspect-square max-w-40 bg-white dark:bg-[#0A0A0A] rounded-xl border border-gray-200 dark:border-gray-900 p-4 flex flex-col items-center justify-center transition-colors duration-300"
      >
        {/* Icon */}
        {IconComponent && (
          <IconComponent
