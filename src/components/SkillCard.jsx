  ...
  return (
    <>
      <div
        ...
        className="group relative flex-shrink-0 w-40 min-w-40 h-36 bg-white dark:bg-[#2C2C2E] rounded-xl border border-gray-200 dark:border-gray-700 p-4 flex flex-col items-center justify-center transition-all duration-300 hover:border-gray-300 dark:hover:border-gray-600"
      >
        {/* Icon */}
        {IconComponent && (
          <IconComponent
